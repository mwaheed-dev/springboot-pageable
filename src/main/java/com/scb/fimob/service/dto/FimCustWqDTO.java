...
/**
 * A DTO for the {@link com.scb.fimob.domain.FimCustWq} entity.
 */
public class FimCustWqDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FimCustWqDTO)) {
            return false;
        }

        FimCustWqDTO fimCustWqDTO = (FimCustWqDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, fimCustWqDTO.id);
    }
