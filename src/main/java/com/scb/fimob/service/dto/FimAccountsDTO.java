...
/**
 * A DTO for the {@link com.scb.fimob.domain.FimAccounts} entity.
 */
public class FimAccountsDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FimAccountsDTO)) {
            return false;
        }

        FimAccountsDTO fimAccountsDTO = (FimAccountsDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, fimAccountsDTO.id);
    }
